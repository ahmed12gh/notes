...
[^2]:**produce the cerumen, the ear wax**
## Holocrine glands
The secretion is discharged by **disintegration** of the cell (programmed cell death).
Example:
- sebaceous glands, 
- tarsal glands of the eye.`situated upon the inner surfaces of the eyelids, between the tarsi and conjunctiva`

# Paracrine secretion 
Cells secrete substances into the **extracellular matrix** that affect **near** by cells by **diffusion**,
*secretion do not enter blood stream*. E.g. : 
- Endothelial cells secrete **vaso-dilators** act on **smooth** muscles to relax **vascular** wall
# Autocrine secretion 
*Cells secrete substances affecting the same cell*. The secretion is either 
- **excitatory** or
- **inhibitory**.

Example: Activation of cells of immune system by **interleukins**[^3]
...
# Medical Applicaiton  
## Acne vulgaris 
is an Excessive **holocrine** secretion of **sebum** and **keratin** triggered by the surge of the steroid hormone **testosterone** that occurs in both genders at **puberty** frequently leads to *blocked ducts within the gland*. Activity of the normal skin bacterium within the blocked duct commonly produces localized inflammation.
